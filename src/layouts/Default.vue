    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" :class="{ show : menuCollapsed}">
        <ul class="navbar-nav mr-auto">
          ...
          <router-link :to="{ name: 'account.index' }" active-class="active" class="nav-item" tag="li">
            <a class="nav-link">Account</a>
          </router-link>
          <router-link :to="{ name: 'email.index' }" active-class="active" class="nav-item" tag="li">
            <a class="nav-link">New Email</a>
          </router-link>
        </ul>
